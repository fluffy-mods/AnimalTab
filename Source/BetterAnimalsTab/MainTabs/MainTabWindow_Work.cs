...
//        {
//            for ( var i = 0; i < _visibleWorkTypeDefsInPriorityOrder.Count; i++ )
//            {
//#if DEBUG
//                Log.Message( "Attempting paste..." );
//#endif
//                if ( p.story != null && !p.story.WorkTypeIsDisabled( _visibleWorkTypeDefsInPriorityOrder[i] ) &&
//                     _copy[i] >= 0 )
//                {
//#if DEBUG
...
//                Pawns.All(
//                          p =>
//                          p.workSettings.GetPriority( work ) == 1 || p.story == null ||
//                          p.story.WorkTypeIsDisabled( work ) );
...
//                Pawns.All(
//                          p =>
//                          p.workSettings.GetPriority( work ) == 0 || p.story == null ||
//                          p.story.WorkTypeIsDisabled( work ) );
...
//            var position = new Rect( 0f, 0f, rect.width, 40f );
...
//            // use manual toggle
//            var rect2 = new Rect( 5f, 5f, headerWidth, 30f );
//            bool useWorkPriorities = Current.Game.playSettings.useWorkPriorities;
//            Widgets.CheckboxLabeled( rect2, "ManualPriorities".Translate(),
...
//            var detailRect = new Rect( 3 * ( headerWidth + 5f ) + 5f, 5f, headerWidth, 30f );
...
//            var rect3 = new Rect( headerWidth + 10f, 5f, headerWidth, 30f );
//            var rect4 = new Rect( 2 * ( headerWidth + 5f ) + 5f, 5f, headerWidth, 30f );
...
//            GUI.EndGroup();
//            var position2 = new Rect( 0f, 40f, rect.width, rect.height - 40f );
//            GUI.BeginGroup( position2 );
//            Text.Font = GameFont.Small;
//            Text.Anchor = TextAnchor.LowerCenter;
//            GUI.color = Color.white;
//            var rectname = new Rect( 0f, 20f, num3, 33f );
...
//            Text.Anchor = TextAnchor.UpperLeft;
//            var outRect = new Rect( 0f, 50f, position2.width, position2.height - 50f );
...
//                float num5 = num3 + 15f;
//                var rect5 = new Rect( num5 - vector.x / 2f, 0f, vector.x, vector.y );
//                if ( num4 % 2 == 1 )
//                {
//                    rect5.y += 20f;
//                }
...
//            {
//                var topLeft = new Vector2( num, rect.y + 2.5f );
//                Widgets_Work.DrawWorkBoxFor( topLeft, p, workTypeDef );
//                var rect2 = new Rect( topLeft.x, topLeft.y, 25f, 25f );
...
//            if ( Copied == p )
//            {
//                var rectCancel = new Rect( num + 17f, rect.y + 6f, 16f, 16f );
...
//            else
//            {
//                var rectCopy = new Rect( num + 6f, rect.y + 6f, 16f, 16f );
...
//            {
//                var rectPaste = new Rect( num + 28f, rect.y + 6f, 16f, 16f );
