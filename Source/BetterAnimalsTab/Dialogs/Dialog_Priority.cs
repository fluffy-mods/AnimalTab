...
//        private readonly Texture2D _bottomArrow = ContentFinder<Texture2D>.Get( "UI/Buttons/ArrowBottom" );
//        private readonly Texture2D _downArrow = ContentFinder<Texture2D>.Get( "UI/Buttons/ArrowDown" );
//        private readonly Texture2D _resetButton = ContentFinder<Texture2D>.Get( "UI/Buttons/reset" );
//        private readonly Texture2D _topArrow = ContentFinder<Texture2D>.Get( "UI/Buttons/ArrowTop" );
//        private readonly Texture2D _upArrow = ContentFinder<Texture2D>.Get( "UI/Buttons/ArrowUp" );
//        private static bool _workGiverMoved;
//        private Vector2 _buttonSize = new Vector2( 16f, 16f );
//        private readonly float _entryHeight = 30f;
//        private bool _first = true;
//        private readonly float _height = 550f;
//        private readonly float _margin = 6f;
//        private WorkGiverDef _selectedWorkGiverDef;
//        private WorkTypeDef _selectedWorkTypeDef;
//        private readonly float _width = 350f;
...
//        public override Vector2 InitialSize => new Vector2( _width, _height );
...
//                    workType.workGiversByPriority.OrderByDescending( wg => wg.priorityInType ).ToList();
...
//            var headerRect = new Rect( inRect.xMin, _margin, inRect.width, 50f - _margin );
//            var workTypeListRect = new Rect( inRect.xMin, 50f, inRect.width, areaHeight );
//            var workGiverListRect = new Rect( inRect.xMin, workTypeListRect.yMax + _margin, inRect.width, areaHeight );
...
//            // button areas
//            var workTypeSortRect = new Rect( workTypeListRect.xMax + _margin, workTypeListRect.yMin, _buttonSize.x,
//                                             areaHeight );
//            var workGiverSortRect = new Rect( workGiverListRect.xMax + _margin, workGiverListRect.yMin, _buttonSize.x,
//                                              areaHeight );
//            var resetRect = new Rect( inRect.width - 27f, 13f - _margin / 2, 24f, 24f );
...
//            var workTypeListContent = new Rect( workTypeListRect.AtZero() );
//            var workGiverListContent = new Rect( workGiverListRect.AtZero() );
...
//            if ( Widgets.ButtonImage( resetRect, _resetButton ) )
//            {
...
//                    }
//                    if ( DrawEntry( ref cur, workGiverListContent, workGiver == _selectedWorkGiverDef,
//                                    _selectedWorkTypeDef, workGiver ) )
//                    {
...
//                // draw buttons
//                DrawSortButtons( workGiverSortRect, _selectedWorkGiverDef != null, _selectedWorkTypeDef,
//                                 _selectedWorkGiverDef );
//            }
//        }

//        private bool DrawEntry( ref Vector2 cur, Rect view, bool selected, WorkTypeDef workType,
...
//            else
//            {
//                label = workGiver.label.NullOrEmpty() ? workGiver.verb.CapitalizeFirst() : workGiver.label;
...
//                    System.Text.RegularExpressions.Regex.Replace( workGiver.defName, "([A-Z])", " $1",
...
//            var labelRect = new Rect( cur.x, cur.y, width, height );
//            Widgets.Label( labelRect, label );
//            Text.Anchor = TextAnchor.UpperLeft;
//            Text.Font = GameFont.Small;

//            // set buttonRect for highlighting
//            var buttonRect = new Rect( view.xMin, cur.y, view.width, height );
...
//        private void DrawSortButtons( Rect rect, bool active, WorkTypeDef workType, WorkGiverDef workGiver = null )
//        {
...
//            GUI.BeginGroup( rect );
//            var buttonRect = new Rect( 0f, 0f, _buttonSize.x, _buttonSize.y );
...
//            if ( active && !top )
//            {
//                if ( Widgets.ButtonImage( topRect, _topArrow ) )
//                {
//                    if ( isWorkType )
//                    {
//                        Top( workType );
...
//                    }
//                }
//                if ( Widgets.ButtonImage( upRect, _upArrow ) )
//                {
//                    if ( isWorkType )
//                    {
//                        Up( workType );
...
//                GUI.DrawTexture( topRect, _topArrow );
//                GUI.DrawTexture( upRect, _upArrow );
//                GUI.color = Color.white;
//            }

//            if ( active && !bottom )
//            {
//                if ( Widgets.ButtonImage( downRect, _downArrow ) )
//                {
//                    if ( isWorkType )
//                    {
//                        Down( workType );
...
//                    }
//                }
//                if ( Widgets.ButtonImage( bottomRect, _bottomArrow ) )
//                {
//                    if ( isWorkType )
//                    {
//                        Bottom( workType );
...
//                GUI.DrawTexture( downRect, _downArrow );
//                GUI.DrawTexture( bottomRect, _bottomArrow );
//                GUI.color = Color.white;
//            }
//            GUI.EndGroup();
//        }
...
//                    Find.WindowStack.Add( new Dialog_Message( "Fluffy.WorkPrioritiesDisclaimer".Translate(),
//                                                              "Fluffy.WorkPrioritiesDisclaimerTitle".Translate() ) );
...
//            WorkGiverDef next =
//                workType.workGiversByPriority.First( wgd => wgd.priorityInType < workGiver.priorityInType );
...
//            // we actually switch priorities with the next highest
//            WorkGiverDef next =
//                workType.workGiversByPriority.OrderBy( wgd => wgd.priorityInType )
//                        .First( wgd => wgd.priorityInType > workGiver.priorityInType );
