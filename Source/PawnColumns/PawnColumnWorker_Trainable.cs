...
namespace AnimalTab {
    public class PawnColumnWorker_Trainable: RimWorld.PawnColumnWorker_Trainable {
        public override void DoCell(Rect rect, Pawn pawn, PawnTable table) {
            ...
            Utilities.DrawCheckboxBackground(checkboxRect);

            IntRange steps = Utilities.GetTrainingProgress(pawn, def.trainable);
            bool completed = pawn.training.HasLearned( def.trainable );
            ...
            Widgets.DraggableResult button = Widgets.ButtonInvisibleDraggable(checkboxRect );
